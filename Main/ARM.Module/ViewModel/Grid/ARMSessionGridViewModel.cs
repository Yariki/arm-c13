...
{
    /// <summary>
    /// Клас для відображення сітки з сесіями.
    /// </summary>
    public class ARMSessionGridViewModel : ARMGridViewModelBase<Session>
    {
        /// <summary>
        /// Створити екземпляр <see cref="ARMSessionGridViewModel"/> class.
        /// </summary>
        ...
        {
            get { return Resource.AppResource.Resources.Model_Session_Title; }
        }
    }
}